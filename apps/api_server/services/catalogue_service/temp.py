...
#     )
#     structure = db.Column(db.String(10), default=STANDALONE)
#     upc = db.Column(db.String(64), nullable=False, unique=True)
#     child_id = db.Column(db.Integer, db.ForeignKey('catalogue_product.id'))
#     children = db.relationship('CatalogueProduct', remote_side=id)
#
#     # title = db.Column(db.Column)
#
