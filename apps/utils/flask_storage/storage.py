...
class Storage(object):
    """
        ...
        That is inspired Django's Storage(django.core.files.storage)
        and Django-Storage(https://github.com/jschneier/django-storages)
    """
    ...
    def save(self, name, content, max_length=None):
        ...
        :param content:
        :type content: werkzeug.FileStorage
        ...
        name = get_available(name, max_length=max_length)
